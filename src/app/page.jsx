...
import CartVenue from "@/components/CartVenue";
import TournamentCart from "@/components/TournamentCart";

function Home() {
  return (
    <div className="flex flex-col items-center gap-4">
      <div className="max-w-screen-xl bg-[#f5f5f5] h-auto flex flex-col gap-10">
        <div className="bg-gray-400 w-[1280px] h-[300px]"></div>
        <div className="flex gap-4">
          <div className="bg-gray-400 w-[416px] h-[200px]"></div>
          <div className="bg-gray-400 w-[416px] h-[200px]"></div>
          <div className="bg-gray-400 w-[416px] h-[200px]"></div>
        </div>
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-4 justify-center">
            <div className="flex gap-4 bg-gray-400 w-[200px] justify-center items-center h-[70px] p-4">
              <svg
                width="20px"
                height="20px"
                viewBox="0 0 24 24"
        ...
        <div className="flex flex-col gap-4">
          <div className="flex justify-between">
            <h1 className="font-bold text-xl">Feature Venue</h1>
            <div className="flex">
                <a className="flex items-center font-bold text-xl" href="#">more
                <svg
                  width="30px"
                  height="30px"
                  viewBox="0 0 24 24"
        ...
        <div className="flex flex-col gap-4">
          <div className="flex justify-between">
            <h1 className="font-bold text-xl">Activity Nearby</h1>
            <div className="flex">
                <a className="flex items-center font-bold text-xl" href="#">more
                <svg
                  width="30px"
